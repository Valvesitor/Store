...
export async function HomeCategories() {
  ...
  return (
    <section id="categorias" className="relative overflow-hidden bg-background tws-corner-lines">
          ...
          {categories.map((category) => {
            ...
            return (
              <Link
                ...
                className="group relative min-h-40 overflow-hidden rounded-2xl border border-primary/25 bg-card/75 shadow-sm transition-all hover:-translate-y-1 hover:border-primary/50 hover:shadow-md"
              >
                <Image
                ...
                />
                <div className="absolute inset-0 bg-gradient-to-t from-[#fff8eb] via-[#fff8eb]/80 to-[#fff8eb]/25" />
                <div className="relative flex min-h-40 flex-col justify-end p-4">
                  <span className="mb-3 flex h-9 w-9 items-center justify-center rounded-2xl border border-primary/30 bg-primary/10 text-primary">
